...
<body>
    ...
    <script type="text/javascript" src="http://localhost:85/users/assets/sweetalert.js"></script>
    <script type="text/javascript" src="http://localhost:85/users/assets/jquery.js"></script>
    <script type="text/javascript" src="http://localhost:85/users/assets/bootstrapjs.js"></script>
